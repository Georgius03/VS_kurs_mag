...
Используемые выводы микроконтроллера приведены на рисунке 18, а также сведена в текстовом формате в таблицу 3.

**Рисунок 18 – Используемые выводы микроконтроллера**
**Таблица 3 – Сводная таблица используемых выводов микроконтроллера**
